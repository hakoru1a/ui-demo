...
const SupplierTable = ({ table, data, loading = false, initialPageSize = 10 }: SupplierTableProps) => {
  // Render table
  const renderTable = () => {
    if (loading) {
    ...
    if (data.length === 0) {
      return <EmptyTable msg="No suppliers found" />;
    }
