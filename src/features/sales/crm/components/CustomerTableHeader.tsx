...
import { CUSTOMER_URLS, CUSTOMER_STATUS_OPTIONS, COUNTRY_OPTIONS } from '../types/constants';
                ...
                <Box sx={{ p: 2.5 }}>
                  <Grid container spacing={2}>
                    ...
                    <Grid size={{ xs: 12, sm: 4 }}>
                      <TextField
                        label="Tên công ty"
                        value={getFilterValue('companyName') || ''}
                    ...
                    <Grid size={{ xs: 12, sm: 4 }}>
                      <SelectField
                        ...
                        options={[{ value: '', label: 'Tất cả' }, ...CUSTOMER_STATUS_OPTIONS]}
                        fullWidth
                        size="medium"
                      />
                    </Grid>
    ...
    <>
      ...
      >
        <Stack direction="row" spacing={2} alignItems="center" sx={{ width: '100%' }}>
          <TextField
            placeholder="Tìm kiếm theo mã KH, tên công ty, người liên hệ, email..."
            value={searchValue}
          ...
          {/* Xóa nhiều khách hàng - Secondary, Conditional (when ≥1 selected) */}
          {hasSelection && onBulkDelete && (
            <Button variant="outlined" color="error" startIcon={<DeleteOutlined />} onClick={handleBulkDelete}>
              Xóa nhiều KH ({selectedCount})
            </Button>
          )}

          {/* Tạo khách hàng - Primary, Always */}
