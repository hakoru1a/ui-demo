...
const ComplaintTable = ({ table, data, loading = false, initialPageSize = 10 }: ComplaintTableProps) => {
  const renderTable = () => {
    if (loading) {
    ...
    if (data.length === 0) {
      return <EmptyTable msg="Không tìm thấy khiếu nại nào" />;
    }
