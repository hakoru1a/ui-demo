...
const TrainingTable = ({ table, data, loading = false, initialPageSize = 10 }: TrainingTableProps) => {
  // Render table
  const renderTable = () => {
    if (loading) {
    ...
    if (data.length === 0) {
      return <EmptyTable msg="Không tìm thấy khóa đào tạo nào" />;
    }
