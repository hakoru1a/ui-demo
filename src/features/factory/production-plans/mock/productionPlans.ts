...
export const mockProductionPlans: ProductionPlan[] = [
  {
    ...
    startDate: dateHelper.addDay(new Date(), 7).toDate(),
    endDate: dateHelper.addDay(new Date(), 37).toDate(),
  ...
  },
  {
    ...
    startDate: dateHelper.addDay(new Date(), 10).toDate(),
    endDate: dateHelper.addDay(new Date(), 40).toDate(),
  ...
  },
  {
    ...
    plannedQuantity: 500,
    startDate: dateHelper.addDay(new Date(), -10).toDate(),
    endDate: dateHelper.addDay(new Date(), 5).toDate(),
  ...
  },
  {
    ...
    plannedQuantity: 800,
    startDate: new Date(),
    endDate: dateHelper.addDay(new Date(), 15).toDate(),
  ...
  },
  {
    ...
    startDate: dateHelper.addDay(new Date(), 20).toDate(),
    endDate: dateHelper.addDay(new Date(), 50).toDate(),
