...
const BatchTable = ({ table, data, loading = false, initialPageSize = 10 }: BatchTableProps) => {
  // Render table
  const renderTable = () => {
    if (loading) {
    ...
    if (data.length === 0) {
      return <EmptyTable msg="Không tìm thấy lô sản xuất nào" />;
    }
