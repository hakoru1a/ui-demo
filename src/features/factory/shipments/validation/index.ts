 ...
 */
export const shipmentSchema = yup.object<ShipmentFormData>().shape({
...
/**
 * Default values for Shipment form
 */
export const shipmentDefaultValues: ShipmentFormData = {
  code: '',
  issueDate: new Date(),
  issueType: 'warehouse',
  warehouseId: '',
 ...
 */
export type ShipmentSchemaType = yup.InferType<typeof shipmentSchema>;
