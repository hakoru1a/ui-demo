...
const ContractTable = ({ table, data, loading = false, initialPageSize = 10 }: ContractTableProps) => {
  // Render table
  const renderTable = () => {
    if (loading) {
    ...
    if (data.length === 0) {
      return <EmptyTable msg="No contracts found" />;
    }
